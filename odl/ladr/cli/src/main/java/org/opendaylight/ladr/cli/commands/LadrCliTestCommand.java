 ...
 */
package org.opendaylight.ladr.cli.commands;
...
public class LadrCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(LadrCliTestCommand.class);
    protected final LadrCliCommands service;

    public LadrCliTestCommand(final LadrCliCommands service) {
